...
skills=[
  ...
  {name:"Nest.js",icons:["icon-nestjs"],description:"Proficient in building modular, maintainable, and scalable backend applications using NestJS. Experienced in architecture, dependency injection, decorators, and microservices WebSockets to create robust enterprise-level APIs."},
  {name:"Python",icons:["fa-python"],description:"Experienced for backend development, automation, and data processing. proficient with Python's core features, OOP, and popular libraries like pandas, FastAPI, and SQLAlchemy."},
